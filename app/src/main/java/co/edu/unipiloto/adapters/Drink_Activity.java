...
public class Drink_Activity extends AppCompatActivity {
    ...
    private class UpdateDrinkTask extends AsyncTask<Integer, Void, Boolean>{
        ...
        protected Boolean doInBackground(Integer...drinks){
            ...
            SQLiteOpenHelper starbuzzDatabaseHelper = new StarBuzzDatabasehelper(Drink_Activity
                    .this);
            try{
                SQLiteDatabase db = starbuzzDatabaseHelper.getWritableDatabase();
        ...
        protected void onPostExecute(Boolean success){
            if(!success){
                Toast toast = Toast.makeText(Drink_Activity.this, "Database unavailable", Toast
                        .LENGTH_SHORT);
                toast.show();
            }
        }
